...
@app.route("/perfil/<id_usuario>") # Nesse caso fizemos a mudança em relação a quem nos referimos quando estamos buscando acessar o nosso usuário para nossa página de perfil. nesse caso fazemos uso do id_usuario pois  o id do mesmo é o único valor que define o usuário como único.
@login_required  
